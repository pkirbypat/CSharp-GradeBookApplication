            ...
            try
            {
                using (var consoleInputStream = new StringReader("close"))
                {
                    ...
                    using (var consolestream = new StringWriter())
                    {
                        ...
                        Assert.True(output.Contains("create requires a name and type of gradebook."));
                    }
                }
            }
            finally
        ...
        public void InstantiateGradeBookTest()
        {
            ...
            try
            {
                ...
                using (var consoleInputStream = new StringReader("close"))
                {
                    ...
                    using (var consolestream = new StringWriter())
                    {
                        ...
                        Assert.True(output.Contains("standard"));
                    }
                }
            }
            finally
            ...
            try
            {
                using (var consoleInputStream = new StringReader("close"))
                {
                    ...
                    using (var consolestream = new StringWriter())
                    {
                        ...
                        Assert.True(output.Contains("ranked"));
                    }
                }
            }
            finally
            ...
            try
            {
                using (var consolestream = new StringWriter())
                {
                    ...
                    Assert.True(output.Contains("incorrect is not a supported type of gradebook, please try again"));
                }
            }
            finally
            {
